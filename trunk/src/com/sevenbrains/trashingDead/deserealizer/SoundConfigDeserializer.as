package com.sevenbrains.trashingDead.deserealizer {
	...
	public class SoundConfigDeserializer extends AbstractDeserealizer {
		
		private var _idsMap:Dictionary;
		
		public function SoundConfigDeserializer(xml:XML) {
			super(xml);
			_idsMap = new Dictionary();
		}
		
		override public function deserialize(source:XML):void {
			_map = new Dictionary();
