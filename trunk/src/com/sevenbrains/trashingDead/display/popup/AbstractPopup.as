package com.sevenbrains.trashingDead.display.popup
{
    ...
    /**
     * Purpose is to Load an Asset , implements IPopup
     * @see IPopup  
     * @author matiasm
     * 
     */
    public class AbstractPopup extends Sprite implements IPopup
    {
        ...
        public function AbstractPopup(loader:ILoader = null)
        {
            _destroyed = false;
            this.loader = loader;
        }
         ...
         * 
         */
        protected function set loader(value:ILoader):void
        {
            _loader = value;
        }
        ...
        {
            if (!this._loader) throw new IllegalOperationError("Loader required to open the popup" + this);
