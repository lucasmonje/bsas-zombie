package com.sevenbrains.trashingDead.display.popup.nodes {
	...
	public class PopupAsynchronicNode implements IPopupNode {
		...
		protected function createLoader():DefaultAssetLoader {
		...
		protected function onLoaded(e:Event):void {
			removeListeners();
			if (_callback != null) {
				_callback(true, this, (e.target as DefaultAssetLoader).contentLoaderInfo.loaderURL);
			}
		}
		...
		protected function onError(e:Event):void {
			...
			removeListeners();
			if (_callback != null) {
				_callback(false, this, (e.target as DefaultAssetLoader).contentLoaderInfo.loaderURL);
			}
		}
		
		public function removeFrom(popup:Popup):void {
			var loader:DefaultAssetLoader = map[popup];
			ASSERT(loader.content, url);
			DisplayUtil.remove(loader.content);
			delete map[popup];
		}
