package com.sevenbrains.trashingDead.managers
{
	...
	[Event(name="timeUpdateSecond",type="events.GameTimerEvent")]
	[Event(name="timeUpdate",type="events.GameTimerEvent")]
	[Event(name="pause",type="events.GameTimerEvent")]
	[Event(name="resume",type="events.GameTimerEvent")]
